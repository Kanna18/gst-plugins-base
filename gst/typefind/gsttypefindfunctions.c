...
mmt_type_find (GstTypeFind * tf, gpointer unused)
{
	...
	guint tip = GST_TYPE_FIND_MAXIMUM;
	const gchar *variant = "iso-fragmented";
...
qt_type_find (GstTypeFind * tf, gpointer unused)
{
  ...
  const gchar *variant = NULL;
      GST_DEBUG ("LPLPLPLPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPP");
      if(tf->is_mmt)
      {
	      GST_DEBUG ("IT IS MMT... LPLPLPLPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPP");
